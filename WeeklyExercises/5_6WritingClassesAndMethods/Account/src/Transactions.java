...
public class Transactions
{
   ...
   public static void main (String[] args)
   {
      ...
      //adding account with new constructor which initialises initial balance at zero
      Account acct4  = new Account ("William Smith", 67691);
      //verifying that account balance is initialised to zero
      System.out.println("Smiths balance after creating an account: " + acct4.getBalance());
      ...
      //created account with balance initialised
